            ...
            children: [
              Padding(
                ...
                child: ElevatedButton.icon(
                  style: ElevatedButton.styleFrom(// Warna teks
                    textStyle: TextStyle(
                      fontSize: 20,
                      fontWeight: FontWeight.bold,
                      fontFamily: GoogleFonts.poppins().fontFamily
                    ), // Mengatur ukuran font
                    fixedSize: Size(450, 100), // Mengatur tinggi dan lebar tombol
              ...
              Padding(
                ...
                child: ElevatedButton.icon(
                  style: ElevatedButton.styleFrom(// Warna teks
                    ...
                    backgroundColor: Color(0xFF14213D),// Mengatur jarak ikon dan label
                  ).merge(
                    ButtonStyle(
                      iconSize: MaterialStateProperty.all<double>(50)
                    )
