              ...
              child: ElevatedButton(
                ...
                onPressed: () {
                  Navigator.pushAndRemoveUntil(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const MainRouting(selectedIndex: 2)),
                    (route) => false,
                  );
                },
                child: Row(
                            ...
                            children: List.generate(
                              ...
                              (index) => Container(
                                child: GestureDetector(
                                  onTap: () {
                                    ById byId = ById(
                                        byId: jenisPromo.dataPromo[index].id);
