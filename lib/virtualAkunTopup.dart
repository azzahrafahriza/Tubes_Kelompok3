...
class VirtualAkunTopup extends StatefulWidget {
  const VirtualAkunTopup({super.key});
            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    Text("Biaya Admin", style: TextStyle(fontSize: 16, color: Colors.black, fontFamily: GoogleFonts.poppins(fontWeight: FontWeight.w600).fontFamily),),
                    Text("Rp. 500", style: TextStyle(fontSize: 16, color: Colors.black, fontFamily: GoogleFonts.poppins(fontWeight: FontWeight.w600).fontFamily),),
                  ],
                ),
                Container(
